...
namespace LADXRandomizer
{
    ...
    class Randomizer
    {
        ...
        public void distributeItem(Item item)
        {
            ...
            {
                Console.Write("COULD NOT FIND VALID LOCATION FOR ITEM " + item + " IN FOLLOWING LIST OF LOCATIONS: " +  "\n" + createLocListDump(locs));
                return;
            }
        }
        ...
        private void randomizeDungeon(Dungeon d)
        {
            ...
            {
                distributeItem(locTemp, SMALL_KEY);
            }
            distributeItem(locTemp, NIGHTMARE_KEY);
            distributeItem(locTemp, MAP);
            distributeItem(locTemp, STONE_BEAK);
            distributeItem(locTemp, COMPASS);
